...
public class CommandData : IDisposable {
  ...
  public CommandData(IntPtr cPtr, bool cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = new HandleRef(this, cPtr);
  }

  public static HandleRef getCPtr(CommandData obj) {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          if (Noesis.Kernel.IsInitialized()) { NoesisGUI_PINVOKE.delete_CommandData(swigCPtr);}
        }
  ...
  public CommandBindingCollection GetCommandBindings() {
    IntPtr cPtr = NoesisGUI_PINVOKE.CommandData_GetCommandBindings(swigCPtr);
  ...
  public InputBindingCollection GetInputBindings() {
    IntPtr cPtr = NoesisGUI_PINVOKE.CommandData_GetInputBindings(swigCPtr);
