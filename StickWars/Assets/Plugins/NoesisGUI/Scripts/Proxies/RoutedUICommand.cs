...
public class RoutedUICommand : RoutedCommand {
  ...
  public RoutedUICommand(IntPtr cPtr, bool cMemoryOwn) : base(NoesisGUI_PINVOKE.RoutedUICommand_SWIGUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  public static HandleRef getCPtr(RoutedUICommand obj) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          if (Noesis.Kernel.IsInitialized()) { NoesisGUI_PINVOKE.delete_RoutedUICommand(swigCPtr);}
        }
