...
public class DragCompletedEventArgs : RoutedEventArgs {
  ...
  public DragCompletedEventArgs(IntPtr cPtr, bool cMemoryOwn) : base(NoesisGUI_PINVOKE.DragCompletedEventArgs_SWIGUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  public static HandleRef getCPtr(DragCompletedEventArgs obj) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          if (Noesis.Kernel.IsInitialized()) { NoesisGUI_PINVOKE.delete_DragCompletedEventArgs(swigCPtr);}
        }
  ...
  public DragCompletedEventArgs(BaseComponent s, bool c, float h, float v) : this(NoesisGUI_PINVOKE.new_DragCompletedEventArgs(BaseComponent.getCPtr(s), c, h, v), true) {
    #if UNITY_EDITOR
    if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
    #endif
  }
