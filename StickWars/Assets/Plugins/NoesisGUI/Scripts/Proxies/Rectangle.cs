...
public class Rectangle : Shape {
  ...
  public Rectangle(IntPtr cPtr, bool cMemoryOwn) : base(NoesisGUI_PINVOKE.Rectangle_SWIGUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  public static HandleRef getCPtr(Rectangle obj) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          if (Noesis.Kernel.IsInitialized()) { NoesisGUI_PINVOKE.delete_Rectangle(swigCPtr);}
        }
  ...
  public Rectangle() : this(NoesisGUI_PINVOKE.new_Rectangle(), true) {
    #if UNITY_EDITOR
  ...
  public static DependencyProperty RadiusXProperty {
    set {
      NoesisGUI_PINVOKE.Rectangle_RadiusXProperty_set(DependencyProperty.getCPtr(value));
      #if UNITY_EDITOR
      if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
      #endif
    } 
  ...
  public static DependencyProperty RadiusYProperty {
    set {
      NoesisGUI_PINVOKE.Rectangle_RadiusYProperty_set(DependencyProperty.getCPtr(value));
      #if UNITY_EDITOR
      if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
      #endif
    } 
  ...
  public new static void Extend(System.Type type) {
    ...
    NoesisGUI_PINVOKE.Extend_Rectangle(typeClassPtr);
    #if UNITY_EDITOR
    if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
    #endif
  }
